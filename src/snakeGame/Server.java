...
public class Server {
	...
	/*
	 * Constructor to create a sever for the game.
	 * Handle most of the games activities.
	 * Passes the number of AI needed.
	 */
	...
	/*
	 * Method to create and stored all AI
	 * snake players into the List called comp
	 */
